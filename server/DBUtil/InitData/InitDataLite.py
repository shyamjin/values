...
users_to_remove=["SuperAdmin","DPMsysCI"] # REMOVE THESE USERS
config_to_remove=["CloneRequestService",
                  "CloneAccountServiceDetails"
                  "DistributionCenterService",
                  "ProposedToolService",
                  "JenkinsAuth",
                  "ContributionCenterService"] # REMOVE THESE CONFIG_DATA
config_to_update=[] # UPDATE THESE CONFIG_DATA
...
ROLE_GROUPING = [
    {
        ...
        "permissiongroup": ["ToolSetView", "ToolView", "DeploymentRequestView", \
                            ...
                            "UsersGroupsView","StateView", "ToolsOnMachineView",\
    ...
    #             },
    {
        ...
        "permissiongroup": [
            ...
            "UserUpdate", "UserDelete", "RoleView", \
            "RoleCreate", "RoleUpdate", "PermissionsView", \
            "GroupView", "GroupCreate", "GroupUpdate", \
            "GroupDelete", "ToolSetDelete",\
            "ToolSetUpdate", "ToolSetView", "ToolView", \
            "ToolUpdate", "ToolDelete", \
            "DeploymentRequestView", "DeploymentRequestCreate", \
            "DeploymentRequestUpdate", "DeploymentRequestDelete", \
            "VersionsView", "VersionsCreate", "VersionsUpdate", \
                            "BuildView", "BuildCreate", "BuildUpdate", "DocumentView", \
                            "DocumentCreate", "DocumentUpdate", "DeploymentfieldsView", \
                            ...
                            "MachineView", "MachineCreate", "MachineUpdate", \
                            "MachineDelete", "MediaFilesView", "MediaFilesCreate", \
                            "MediaFilesUpdate", "MediaFilesDelete", "DistributionSyncView", \
                            "Admin", "Catalog", "ChangePassword", "ConfigView", \
                            "ConfigUpdate", "SystemDetailsView", "SyncServices", \
                            "SystemDetailsCreate",\
                            "PreRequisites", "DeploymentGroupView", \
                            "DeploymentGroupCreate", "DeploymentGroupDelete", \
                            "DeploymentGroupUpdate", "MachineGroupsDelete", \
                            "MachineGroupsUpdate", "MachineGroupsCreate", \
                            "MachineGroupsView", "UsersGroupsView", "UsersGroupsCreate", \
                            ...
                            "DeploymentUnitTypeView", "DeploymentUnitTypeCreate", \
                            "DeploymentUnitTypeUpdate", "DeploymentUnitTypeDelete", \
                            "DeploymentUnitUpdate", \
                            "DeploymentUnitDelete", "DeploymentUnitSetView", \
                            "DeploymentUnitSetUpdate", \
                            "DeploymentUnitSetDelete", "ReportsView", \
                            "DeploymentUnitView", "Plugins", "MonitoringView", "PersonalizeCreate",\
                            "StateView", "ToolsOnMachineView",\
                            "FlexibleAttributeView","AuditingView",\
                            "SystemAdministration","RepositoryView","RepositoryCreate","RepositoryDelete","RepositoryUpdate"],
        "status":"Active"
    }
]