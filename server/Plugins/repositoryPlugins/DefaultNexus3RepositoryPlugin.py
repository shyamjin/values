...
from Services import Nexus3RepositoryServiceHandler,HelperServices
...
class Handler():
    ...
    def __init__(self,repository_details):
        ...
        self.serviceHandler = Nexus3RepositoryServiceHandler.\
                                                Nexus3RepositoryServiceHandler(self.repository_details)
    ...
    def validate_repository_details(self, **keyargs):
        ...
        '''
        mandatory_keys=['add_script_url', 'remove_script_url', 
                        'repo_user', 'run_script_url', 'mvn_url', 'upload_type', 
                        'force_upload', 'repo_pass', 'upload_protocol','base_url', 'file_path_url',
                          'list_all_repositories_url']
