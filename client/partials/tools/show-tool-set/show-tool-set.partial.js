...
Author - nlate
Description -
    1. Controller that handles with the common operations required in get tool details tool set
Methods -
    1.
Uses -
    1. View Tool Set - partials/tools/show-tool-set/show-tool-set.partial.html
*/

define(['angular', 'toolSetServicesApp', 'showToolSetInfoComponentControllerApp', 'showToolSetHeaderComponentControllerApp'],function (app) {
  'use strict';

var showToolSetPartialControllerApp = angular.module('showToolSetPartialControllerApp', ['toolSetServicesApp', 'showToolSetInfoComponentControllerApp', 'showToolSetHeaderComponentControllerApp']);

showToolSetPartialControllerApp.controller("ShowToolSetPartialController",function($scope, $stateParams, ToolSetByID, GetAllTools, $rootScope) {
    var toolList = [];
    ToolSetByID.get({
       id: $stateParams.id
    },
