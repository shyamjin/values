...
var newToolsComponentControllerApp = angular.module('newToolsComponentControllerApp', ['requestTabComponent', 'settingsServicesApp']);

newToolsComponentControllerApp.controller('NewToolListController', function ($scope, $state, $rootScope, NewTools, ImportUpdate, UpdatedTools) {
    $scope.selectedTools = [];
    ...
    $scope.selectMultipleToolsForImport = function(selectedTools)
    {
    ...
    $scope.applications = NewTools.query({
    },
