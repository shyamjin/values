...
var verticalTabComponentControllerApp = angular.module('verticalTabComponentControllerApp', ['showToolPartialControllerApp']);

verticalTabComponentControllerApp.controller('VerticalTabController', function ($scope, $state, $rootScope) {
