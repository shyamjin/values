...
var screenshotBrowserComponentControllerApp = angular.module('screenshotBrowserComponentControllerApp', ['showToolPartialControllerApp']);

screenshotBrowserComponentControllerApp.controller('ScreenshotBrowserController', function ($scope, $state, $rootScope) {
