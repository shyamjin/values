...
var showToolHeaderComponentControllerApp = angular.module('showToolHeaderComponentControllerApp', ['showToolPartialControllerApp']);

showToolHeaderComponentControllerApp.controller('ShowToolHeaderController', function ($scope, $rootScope, $state) {
