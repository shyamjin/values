...
Uses -
    1. Show New Tool - components/tools/show-new-tool/version-form/versionsform.component.html
*/

define(['angular', 'showNewToolPartialControllerApp'],function (app) {
  'use strict';

var showNewVersionComponentControllerApp = angular.module('showNewVersionComponentControllerApp', ['showNewToolPartialControllerApp']);

showNewVersionComponentControllerApp.controller('ShowNewToolVersionController', function ($scope, $state, $rootScope, $window, GetAllTools) {
