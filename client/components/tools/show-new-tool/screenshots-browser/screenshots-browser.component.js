...
Uses -
    1. Show New Tool - components/tools/show-new-tool/header/header.component.html
*/

define(['angular', 'showNewToolPartialControllerApp'],function (app) {
  'use strict';

var showNewToolScreenshotBrowserComponentControllerApp = angular.module('showNewToolScreenshotBrowserComponentControllerApp', ['showNewToolPartialControllerApp']);

showNewToolScreenshotBrowserComponentControllerApp.controller('ShowNewToolScreenshotBrowserController', function ($scope, $state, $rootScope) {
