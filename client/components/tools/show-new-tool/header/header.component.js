...
var showNewToolHeaderComponentControllerApp = angular.module('showNewToolHeaderComponentControllerApp', ['showNewToolPartialControllerApp']);

showNewToolHeaderComponentControllerApp.controller('ShowNewToolHeaderController', function ($scope, $rootScope, $state) {
