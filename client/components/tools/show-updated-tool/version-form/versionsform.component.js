...
Uses -
    1. Show Updated Tool - components/tools/show-updated-tool/version-form/versionsform.component.html
*/

define(['angular', 'showUpdatedToolPartialControllerApp'],function (app) {
  'use strict';

var showUpdatedToolVersionComponentControllerApp = angular.module('showUpdatedToolVersionComponentControllerApp', ['showUpdatedToolPartialControllerApp']);

showUpdatedToolVersionComponentControllerApp.controller('ShowUpdatedToolVersionController', function ($scope, $state, $rootScope, $window, GetAllTools) {
    ...
    $scope.downloadBuild = function(file_path)
    {
