...
Methods -
    1.
Uses -
    1. Edit Tool Set - components/tools/edit-tool-set/popups/addtool-popup.component.html
*/

define(['angular'],function (app) {
  'use strict';

var editToolSetAddToolComponentControllerApp = angular.module('editToolSetAddToolComponentControllerApp', []);

editToolSetAddToolComponentControllerApp.controller("EditToolSetAddToolController",function($scope, $rootScope, GetAllTools, AllToolSet) {
    ...
    $scope.removeToolFromSelectedToolset = function(index)
    {
